        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          ...
          <div className="px-4 py-5 sm:p-6">
            <div className="prose prose-gray max-w-none">
              ...
              <h2 className="text-xl font-semibold text-gray-800 mt-6">Data Access and Deletion</h2>
              <p>
              ...
              <div className="mt-2 p-4 bg-blue-50 rounded-md">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Please include the email address associated with your account and any other identifying information.
                </p>
              </div>
